...
def item_item_recom(item_id, n_recom=5, umbral= 0.999):
    ...
    df_names = pd.read_parquet('sistema_recomendacion.parquet')      # cargamos el arghivo de nombres
    ...
    df_items = pd.read_parquet('caracteristicas_juego.parquet')  # cargamos archivo de features
